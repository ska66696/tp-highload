...
**Discord** — это коммуникационная платформа для общения в тематических сообществах (серверах). Основная задача сервиса — обеспечение текстового и голосового взаимодействия групп пользователей в реальном времени.
